...
/**
 * Label for the Bcc header of a message.
 *
 * @author Sandy McArthur
 */
public class BccAddressesLabel extends AddressesLabel {
    public BccAddressesLabel(final GMMessage message) {
        super(message);
    }

    protected GMAddress[] getAddresses() {
        final GMMessageHeaders headers = getMessage().getHeaders();
        return headers != null ? headers.getBcc() : null;
    }
}
