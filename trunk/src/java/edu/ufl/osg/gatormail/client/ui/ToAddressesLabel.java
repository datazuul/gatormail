...
/**
 * Label for the To header of a message.
 *
 * @author Sandy McArthur
 */
public class ToAddressesLabel extends AddressesLabel {
    public ToAddressesLabel(final GMMessage message) {
        super(message);
    }

    protected GMAddress[] getAddresses() {
        final GMMessageHeaders headers = getMessage().getHeaders();
        return headers != null ? headers.getTo() : null;
    }
}
